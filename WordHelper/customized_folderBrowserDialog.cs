...
namespace WordHelper
{
    ...
    public class FolderNameEditor : UITypeEditor
    {
        ...
        {
            CustomizedFolderBrowserDialog browser = new CustomizedFolderBrowserDialog();
            if (value != null)
            {
    ...
    public class CustomizedFolderBrowserDialog : Component
    {
        /// <summary>
        /// 初始化 FolderBrowser 的新实例
        /// </summary>
        public CustomizedFolderBrowserDialog()
        {
        }
